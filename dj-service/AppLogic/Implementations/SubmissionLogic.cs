...
public class SubmissionLogic(ISubmissionAccess submissionAccess, IEmailAccess emailAccess) : ISubmissionLogic
{
    ...
    private async Task<Response> SendClientEmail(ContactFormSubmission submission)
    {
        ...
        return await _emailAccess.SendEmailAsync(submission.Email, submission.FullName, emailSubject, plainTextContent, htmlContent, "oakley@cdentertainment.co", "CD Entertainment", "oakley@cdentertainment.co", "CD Entertainment");
    }
